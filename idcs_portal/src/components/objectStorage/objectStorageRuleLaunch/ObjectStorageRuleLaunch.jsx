...
const ObjectStorageRuleLaunch = (props) => {
  // props
          ...
          <div className="section">
            ...
            <ButtonGroup>
              {navigationBottom.map((item, index) => (
                <Button
                  intc-id={`btn-ObjectStorageRuleLaunch-navigationBottom ${item.buttonLabel}`}
                  data-wap_ref={`btn-ObjectStorageRuleLaunch-navigationBottom ${item.buttonLabel}`}
                  aria-label={item.buttonLabel}
                  key={index}
                  variant={item.buttonVariant}
                  onClick={item.buttonLabel === 'Add' ? onSubmit : item.buttonFunction}
                >
                  {item.buttonLabel}
                </Button>
              ))}
...
export default ObjectStorageRuleLaunch

...
const LoadBalancerEdit = (props: any): JSX.Element => {
  // props
  ...
  const selectedLoadBalancer = props.selectedLoadBalancer
  ...
  return (
    <>
      ...
      <ErrorModal
        ...
        titleMessage="Could not update your load balancer"
      ...
      {loading ? (
        ...
        <>
          <div className="section">
            <h2 intc-id="LoadBalancerLaunchTitle">
              Edit Load Balancer: {selectedLoadBalancer ? selectedLoadBalancer.name : ''}
            </h2>
          </div>
          <div className="section">
            {buildCustomInput({ id: 'name', configInput: form.name }, null)}
...
export default LoadBalancerEdit

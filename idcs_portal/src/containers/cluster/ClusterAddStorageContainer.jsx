...
const ClusterAddStorageContainer = () => {
  // *****
  // Global state
  // *****
  ...
  const initialState = {
    mainTitle: `Add storage for cluster ${name}`,
    mainSubtitle: '',
    form: {
      fileVolumeFlag: {
  ...
  async function onSubmit() {
    try {
      ...
      await ClusterService.createStorage(payloadCopy, clusterToEdit.uuid)
      setTimeout(() => {
...
export default ClusterAddStorageContainer

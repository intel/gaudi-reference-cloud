...
import { mockEnterprisePendingUser } from '../../mocks/authentication/authHelper'
...
describe('Support Menu Standard user', () => {
  ...
  it('Should NOT show "Submit a ticket" menu option', async () => {
    render(<TestComponent />)
    await waitForSupportMenu()
    expect(screen.queryByTestId('help-menu-Submit-a-ticket')).toBeNull()
  })

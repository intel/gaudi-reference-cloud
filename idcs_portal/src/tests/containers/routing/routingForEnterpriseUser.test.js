...
describe('Routes enterprise User', () => {
  let history = null
  ...
  it('Check enterprise users have NOT access to credit response page', async () => {
    history.push('/billing/creditResponse')
    render(<TestComponent history={history} />)
    expect(await screen.findByText('Page not found')).toBeVisible()
  })

  it('Check enterprise users have NOT access to premium page', async () => {
    history.push('/premium')
    render(<TestComponent history={history} />)
    expect(await screen.findByText('Page not found')).toBeVisible()
  })

  it('Check enterprise users have NOT access to upgrade account', async () => {
    history.push('/upgradeaccount')
    render(<TestComponent history={history} />)
    expect(await screen.findByText('Page not found')).toBeVisible()
  })

  it('Check enterprise users have access to KaaS Create Cluster page', async () => {
    history.push('/cluster/reserve')
    render(<TestComponent history={history} />)
    expect(await screen.findByText('/cluster/reserve')).toBeVisible()
  })

  it('Check enterprise users have access to KaaS My Clusters page in root', async () => {
    history.push('/cluster')
    render(<TestComponent history={history} />)
    expect(await screen.findByText('/cluster')).toBeVisible()
  })

  it('Check enterprise users have access to KaaS Load Balancers reservation page', async () => {
  ...
  it('Check enterprise users have access to KaaS Node Group creation page', async () => {
  ...
  it('Check enterprise users have NOT access with future flag disable to profile apikeys page', async () => {

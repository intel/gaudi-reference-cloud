...
func main() {
	...
	err := func() error {
		...
		cfg := &privatecloudv1alpha1.ComputeMeteringMonitorConfig{}
		...
		_, err = metering_monitor.NewMeteringMonitor(ctx, k8sManager, meteringClient, cfg.MaxUsageRecordSendInterval.Duration)
		if err != nil {

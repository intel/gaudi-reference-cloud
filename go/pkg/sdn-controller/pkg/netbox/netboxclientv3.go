...
func (n *NetBoxClientV3) Version() string {
	return "3"
}

func (n *NetBoxClientV3) ListDevices(ctx context.Context, req ListDevicesRequest) ([]Device, error) {
	...
	return generateV3DeviceResults(res.Results)
}

func generateV3DeviceResults(devices []netbox.DeviceWithConfigContext) ([]Device, error) {
	res := make([]Device, 0)
	for _, device := range devices {
		d := Device{
			...
			DeviceRole:    device.GetDeviceRole().Slug,
...
func (n *NetBoxClientV3) ListInterfaces(ctx context.Context, req ListInterfaceRequest) ([]Interface, error) {
	...
	return generateV3InterfaceResults(result)
}

func generateV3InterfaceResults(networkInterfaces []netbox.Interface) ([]Interface, error) {
...
func (n *NetBoxClientV3) ListIPAddresses(ctx context.Context, req ListIPAddressesRequest) ([]IPAddress, error) {
	...
	return generateV3IPAddressResults(res.Results)
}

func generateV3IPAddressResults(ips []netbox.IPAddress) ([]IPAddress, error) {

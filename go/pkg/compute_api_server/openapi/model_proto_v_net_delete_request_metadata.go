...
// ProtoVNetDeleteRequestMetadata struct for ProtoVNetDeleteRequestMetadata
type ProtoVNetDeleteRequestMetadata struct {
...
func NewProtoVNetDeleteRequestMetadata() *ProtoVNetDeleteRequestMetadata {
	this := ProtoVNetDeleteRequestMetadata{}
	return &this
}
...
func (o ProtoVNetDeleteRequestMetadata) MarshalJSON() ([]byte, error) {
...
type NullableProtoVNetDeleteRequestMetadata struct {
	value *ProtoVNetDeleteRequestMetadata
	isSet bool
}

func (v NullableProtoVNetDeleteRequestMetadata) Get() *ProtoVNetDeleteRequestMetadata {
	return v.value
}

func (v *NullableProtoVNetDeleteRequestMetadata) Set(val *ProtoVNetDeleteRequestMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableProtoVNetDeleteRequestMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableProtoVNetDeleteRequestMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtoVNetDeleteRequestMetadata(val *ProtoVNetDeleteRequestMetadata) *NullableProtoVNetDeleteRequestMetadata {
	return &NullableProtoVNetDeleteRequestMetadata{value: val, isSet: true}
}

func (v NullableProtoVNetDeleteRequestMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtoVNetDeleteRequestMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true

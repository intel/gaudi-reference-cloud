...
// ProtoVNetMetadata struct for ProtoVNetMetadata
type ProtoVNetMetadata struct {
...
func (o ProtoVNetMetadata) MarshalJSON() ([]byte, error) {
...
type NullableProtoVNetMetadata struct {
	value *ProtoVNetMetadata
	isSet bool
}

func (v NullableProtoVNetMetadata) Get() *ProtoVNetMetadata {
	return v.value
}

func (v *NullableProtoVNetMetadata) Set(val *ProtoVNetMetadata) {
	v.value = val
	v.isSet = true
}

func (v NullableProtoVNetMetadata) IsSet() bool {
	return v.isSet
}

func (v *NullableProtoVNetMetadata) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProtoVNetMetadata(val *ProtoVNetMetadata) *NullableProtoVNetMetadata {
	return &NullableProtoVNetMetadata{value: val, isSet: true}
}

func (v NullableProtoVNetMetadata) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProtoVNetMetadata) UnmarshalJSON(src []byte) error {
	v.isSet = true

...
docker tag pvc-base:$image_tag amr-fmext-registry.caas.intel.com/idc-training/trainings/pvc-base:$image_tag
docker push amr-fmext-registry.caas.intel.com/idc-training/trainings/pvc-base:$image_tag

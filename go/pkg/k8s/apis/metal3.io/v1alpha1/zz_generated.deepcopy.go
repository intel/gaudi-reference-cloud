...
func (in *LLDP) DeepCopyInto(out *LLDP) {
	*out = *in
	if in.SwitchCapabilitiesEnabled != nil {
		in, out := &in.SwitchCapabilitiesEnabled, &out.SwitchCapabilitiesEnabled
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SwitchCapabilitiesSupport != nil {
		in, out := &in.SwitchCapabilitiesSupport, &out.SwitchCapabilitiesSupport
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SwitchMgmtAddresses != nil {
		in, out := &in.SwitchMgmtAddresses, &out.SwitchMgmtAddresses
		*out = make([]string, len(*in))
		copy(*out, *in)
	}
	if in.SwitchPortVlans != nil {
		in, out := &in.SwitchPortVlans, &out.SwitchPortVlans

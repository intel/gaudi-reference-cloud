...
// StorageOperatorConfig is the Schema for the Storageoperatorconfigs API.
// It stores the configuration for theStorage Operator.
type StorageOperatorConfig struct {

...
import (
	...
	privatecloud "github.com/intel-innersource/frameworks.cloud.devcloud.services.idc/go/pkg/storage/storage_operator/controllers"
...
func NewMeteringMonitor(ctx context.Context, mgr ctrl.Manager, grpcClient pb.MeteringServiceClient, cfg *cloudv1alpha1.StorageMeteringMonitorConfig) (*MeteringMonitor, error) {
	// Create reconciler
	r := &MeteringMonitor{
...
//+kubebuilder:rbac:groups=private.cloud.intel.com,resources=storages,verbs=get;list;watch;update;patch
...
func (r *MeteringMonitor) getStorage(ctx context.Context, req ctrl.Request) (*cloudv1alpha1.Storage, error) {
...
func (r *MeteringMonitor) processStorage(ctx context.Context, storage *cloudv1alpha1.Storage) (reconcile.Result, error) {
	...
	if startupComplete {
		log.V(1).Info("Begin creating metering record once the storage starts running and has completed running startup scripts")
...
func (r *MeteringMonitor) processDeleteStorage(ctx context.Context, storage *cloudv1alpha1.Storage) (ctrl.Result, error) {
	...
	controllerutil.RemoveFinalizer(storage, privatecloud.StorageMeteringMonitorFinalizer)
...
func (r *MeteringMonitor) CreateRecordInDB(ctx context.Context, storage *cloudv1alpha1.Storage, runningTime time.Duration, firstReadyTimestamp metav1.Time, isDeleted bool) error {
...
func statusChangePredicate() predicate.Predicate {
	return predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			return e.ObjectOld.(*cloudv1alpha1.Storage).Status.Phase != e.ObjectNew.(*cloudv1alpha1.Storage).Status.Phase
		},
	}
}
...
func ignoreStorageWithoutFinalizerPredicate() predicate.Predicate {
	return predicate.Funcs{
		UpdateFunc: func(e event.UpdateEvent) bool {
			...
			return slices.Contains(e.ObjectNew.GetFinalizers(), privatecloud.StorageMeteringMonitorFinalizer)
		},
	}
}

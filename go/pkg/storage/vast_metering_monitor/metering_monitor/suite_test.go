...
func NewStorageInit(namespace string, storageName string, availabilityZone string, uid string) *privatecloudv1alpha1.VastStorage {
	return &privatecloudv1alpha1.VastStorage{
		...
		Status: privatecloudv1alpha1.VastStorageStatus{

...
import (
	...
	cloud "github.com/intel-innersource/frameworks.cloud.devcloud.services.idc/go/pkg/storage/storage_operator/controllers"
...
func main() {
	...
	err := func() error {
		cfg := &privatecloudv1alpha1.StorageOperatorConfig{}
		if configFile != "" {
			var err error
		...
		ctx := context.Background()
		if _, err = cloud.NewStorageOperator(ctx, mgr, &strCntrClient, storageKmsClient); err != nil {

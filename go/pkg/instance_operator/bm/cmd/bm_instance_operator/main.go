...
import (
	...
	controllers "github.com/intel-innersource/frameworks.cloud.devcloud.services.idc/go/pkg/instance_operator/bm/controllers"
...
func main() {
	...
	err := func() error {
		...
		_, err = controllers.NewBmInstanceReconciler(ctx, k8sManager, vNetPrivateClient, vNetClient, cfg)
		if err != nil {

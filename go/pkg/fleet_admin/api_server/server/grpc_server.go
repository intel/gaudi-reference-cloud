...
import (
	...
	"github.com/intel-innersource/frameworks.cloud.devcloud.services.idc/go/pkg/fleet_admin/api_server/fleet_admin"
...
type GrpcService struct {
	...
	FleetAdminService *fleet_admin.FleetAdminService
...
func (s *GrpcService) Start(ctx context.Context) error {
	...
	fleetAdminService, err := fleet_admin.NewFleetAdminService(db, s.cfg)
	if err != nil {
		return err
	}
	s.FleetAdminService = fleetAdminService

	pb.RegisterFleetAdminServiceServer(s.grpcServer, fleetAdminService)

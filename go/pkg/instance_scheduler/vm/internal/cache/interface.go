...
type Cache interface {
	...
	AddNode(ctx context.Context, node *v1.Node) *framework.NodeInfo

	// UpdateNode updates overall information about node.
	// It returns a clone of updated NodeInfo object.
	UpdateNode(ctx context.Context, oldNode, newNode *v1.Node) *framework.NodeInfo
	...
	UpdateSnapshot(ctx context.Context, nodeSnapshot *Snapshot) error

	// Dump produces a dump of the current cache.
	Dump() *Dump

	DumpToLog(ctx context.Context)
}

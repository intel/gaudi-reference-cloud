...
import (
	...
	"github.com/intel-innersource/frameworks.cloud.devcloud.services.idc/go/pkg/firewall_operator/internal/provider/idcfw"
...
func main() {
	...
	var inputConfig controller.FirewallRuleProviderConfig
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "65a58c12.intel.com",
	...
	fwProvider, err := idcfw.NewClient(
		inputConfig.BaseURL,
	...
	if err != nil {
		setupLog.Error(err, "unable to create firewall provider")
		os.Exit(1)
	}
	...
	if err = (&controller.FirewallRuleReconciler{
		...
		FirewallRuleProviderConfig: &inputConfig,
		Provider:                   fwProvider,

...
func init() {
	...
	flag.StringVar(&skipVMClusterCreation, "skipVMClusterCreation", "false", "")
}
...
func TestRegressionSuite(t *testing.T) {
	...
	RunSpecs(t, "IDC - VMaaS Metering Monitoring Business usecases")
}
...
var _ = SynchronizedBeforeSuite(func() []byte {
	...
	logInstance.Println("Starting VMaaS Metering Monitoring Business Usecase test suite")

...
var _ = Describe("Compute Instance API endpoint(VM positive flow)", Label("compute", "lb", "compute_lb", "lb_instance_selectors"), Ordered, ContinueOnFailure, func() {
	var (
		instanceType        string
	...
	When("LB creation by associating instances via selectors", func() {

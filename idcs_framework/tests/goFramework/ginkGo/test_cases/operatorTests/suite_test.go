...
var _ = BeforeSuite(func() {
	...
	logger.Log.Info("Starting Operator  test suite")
	...
	suite.suitedata.Name = "IDC Operator Test Suite"
	...
	suite.testdata.Description = "Test - IDC Operator Test"

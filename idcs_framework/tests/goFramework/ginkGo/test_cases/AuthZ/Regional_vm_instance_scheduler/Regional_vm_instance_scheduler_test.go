package Regional_vm_instance_scheduler
...
var _ = Describe("Check region vm instance scheduler api functionality", func() {
	...
	It("Api call should return a response code different of 500", func() {
		url_passed := os.Getenv("REGIONAL_URL") + "v1/cloudaccounts/639614616031/instances"
		method := "POST"
		error := false

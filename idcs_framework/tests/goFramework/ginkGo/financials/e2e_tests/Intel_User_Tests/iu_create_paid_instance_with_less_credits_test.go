//go:build iu_vm || All || pu_su_iu || In1
// +build iu_vm All pu_su_iu In1
...
var _ = Describe("VM Instance", Ordered, Label("Compute-VMaaS-E2E"), func() {
	...
	It("Create Cloud credits for intel user by redeeming coupons", func() {
		...
		coupon_payload := financials_utils.EnrichCreateCouponPayload(financials_utils.GetCreateCouponPayload(), 0.000001, "idc_billing@intel.com", 1)

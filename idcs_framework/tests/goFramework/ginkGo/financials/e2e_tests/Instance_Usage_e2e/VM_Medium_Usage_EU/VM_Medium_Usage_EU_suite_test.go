package VM_Medium_Usage_EU_test
...
var _ = BeforeSuite(func() {
	...
	auth.Get_config_file_data("../../../data/product_catalog_e2e.json")
...
func TestVMMediumUsageEU(t *testing.T) {
	t.Parallel()
	RegisterFailHandler(Fail)
	RunSpecs(t, "VMMediumUsageEU Suite")
}

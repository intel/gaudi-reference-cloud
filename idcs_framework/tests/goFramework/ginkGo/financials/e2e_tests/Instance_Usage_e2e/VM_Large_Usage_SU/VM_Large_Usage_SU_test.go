package VM_Large_Usage_SU_test
...
var _ = Describe("Check Standard User Product Usage VM Medium", Ordered, Label("Usages-e2e"), func() {
	...
	It("Create paid test instance", func() {
		...
		Expect(bm_name_iu).To(Equal(BMName_iu), "Failed to create VM instance, resposne validation failed")

...
var _ = BeforeSuite(func() {
	...
	compute_url = compute_utils.GetComputeUrlWithRegion()
...
func TestVMBMPU(t *testing.T) {
	t.Parallel()
	RegisterFailHandler(Fail)
	RunSpecs(t, "VM_BM_PU Suite")
}
...
var _ = AfterSuite(func() {
	...
	Expect(delete_response_status).To(Equal(200), "Failed to delete VM_BM instance")

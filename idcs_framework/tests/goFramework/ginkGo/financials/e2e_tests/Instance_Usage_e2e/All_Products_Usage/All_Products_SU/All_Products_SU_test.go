...
var _ = Describe("Check Intel Stanard Usages", Label("Vacuum-tests-Standard"), func() {
	productList := []string{}
	var structResponse GetProductsResponse

	It("Validate Standard cloudAccount using getByName", func() {
	...
	It("Validate Standard cloudAccount using getById", func() {
		logger.Logf.Info("Checking user cloudAccount")
		url := base_url + "/v1/cloudaccounts"

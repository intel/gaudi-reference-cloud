...
var _ = Describe("Check Intel User Usages", Label("Vacuum-tests-Intel"), func() {
	productList := []string{}
	var structResponse GetProductsResponse

	It("Validate Intel cloudAccount using getByName", func() {
	...
	It("Validate Intel cloudAccount using getById", func() {
		logger.Logf.Info("Checking user cloudAccount")
		url := base_url + "/v1/cloudaccounts"

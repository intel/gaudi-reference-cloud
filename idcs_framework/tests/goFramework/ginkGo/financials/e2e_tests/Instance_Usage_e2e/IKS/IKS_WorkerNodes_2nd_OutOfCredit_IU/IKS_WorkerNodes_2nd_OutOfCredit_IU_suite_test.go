package IKS_WorkerNodes_2nd_OutOfCredit_IU_test
...
func TestIKS2ndNodeGroupOutOfCreditIUtest(t *testing.T) {
	t.Parallel()
	RegisterFailHandler(Fail)
	RunSpecs(t, "IKS 2nd NodeGroup OutOfCredit IU test Suite")
}

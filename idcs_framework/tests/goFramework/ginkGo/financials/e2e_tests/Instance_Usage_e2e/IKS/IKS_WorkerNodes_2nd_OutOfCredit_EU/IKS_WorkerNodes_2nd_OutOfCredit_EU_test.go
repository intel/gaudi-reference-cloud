...
var _ = Describe("Check IKS WorkerNodes 2nd OutOfCredit enterprise user", Ordered, Label("IKS"), func() {
	...
	It("Create Cloud credits for enterprise user by redeeming coupons", func() {
		...
		coupon_payload := financials_utils.EnrichCreateCouponPayload(financials_utils.GetCreateCouponPayload(), 4, "eu_user", 1)

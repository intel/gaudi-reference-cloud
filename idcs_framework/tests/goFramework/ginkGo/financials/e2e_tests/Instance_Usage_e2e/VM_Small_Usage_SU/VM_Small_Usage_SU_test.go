package VM_Small_Usage_SU_test
...
var _ = Describe("Check Standard User Product Usage VM Small", Ordered, Label("Usages-e2e"), func() {
	...
	It("Get the created instance details from poduct catalog and validate", func() {
		...
		fmt.Println("product_filter", product_filter)

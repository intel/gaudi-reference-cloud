...
var _ = Describe("Check Premium User Rates", Ordered, Label("Product-Catalog-E2E-Premium"), func() {
	...
	It("Create paid BM test instance", func() {
		...
		instance_payload := compute_utils.EnrichInstancePayload(compute_utils.GetInstancePayload(), bm_name_iu, "vm-spr-sml", "ubuntu-22.04-server-cloudimg-amd64-latest", ssh_publickey_name_created, vnet_created)

...
var _ = Describe("Check Intel User Rates Multi Region", Ordered, Label("Multi-Region-E2E"), func() {
	...
	It("Validate Intel cloudAccount", func() {
		...
		Expect(cloudAccountType).To(Equal("ACCOUNT_TYPE_INTEL"), "Failed to retrieve CloudAccount Type")

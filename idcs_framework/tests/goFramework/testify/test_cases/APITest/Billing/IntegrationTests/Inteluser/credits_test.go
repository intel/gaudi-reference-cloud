//go:build Functional || Billing || Intel || IntelIntegration || Integration || CreditsTest
// +build Functional Billing Intel IntelIntegration Integration CreditsTest
...
func (suite *BillingAPITestSuite) Test_Intel_Add_Credit_And_Check_Credit_Response() {
	...
	assert.Equal(suite.T(), found, true, "Test Failed while validating credits data, coupon Code not found in response for (Intel user)")
...
func (suite *BillingAPITestSuite) Test_Intel_Add_Expired_Credit_And_Check_Credit_Response() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Add_Multiple_Credit_And_Check_Credit_Response() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	usage_err := billing.ValidateUsage(cloudAccId, float64(30), financials_utils.GetIntelSmlVmRate(), "vm-spr-sml", authToken)
	...
	assert.Equal(suite.T(), found1, true, "Test Failed while validating credits data, coupon Code not found in response for (Intel user)")
	assert.Equal(suite.T(), found2, true, "Test Failed while validating credits data, coupon Code not found in response for (Intel user)")
...
func (suite *BillingAPITestSuite) Test_Intel_Delete_Instance_And_Validate_Usage() {
...
func (suite *BillingAPITestSuite) Test_Intel_Add_Expired_Credit_And_Check_Credit_Response_After_Adding_More_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Create_Free_Instance_Without_Credits() {
	suite.T().Skip()
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
...
func (suite *BillingAPITestSuite) Test_Intel_Create_Paid_Instance_Without_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Create_Free_Instance_With_Coupon_Credits() {
	suite.T().Skip()
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
...
func (suite *BillingAPITestSuite) Test_Intel_Create_Paid_Instance_With_Coupon_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Launch_Paid_Instance_After_Using_All_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Launch_Free_Instance_After_Using_All_Credits() {
	suite.T().Skip()
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
...
func (suite *BillingAPITestSuite) Test_Intel_Launch_Paid_Instance_After_Using_Less_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Launch_Paid_Instance_After_Using_More_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Launch_Free_Instance_After_Using_More_Credits() {
	suite.T().Skip()
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
...
func (suite *BillingAPITestSuite) Test_Intel_Redeem_Coupon_After_Using_Less_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Redeem_Coupon_After_Using_More_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Redeem_Coupon_After_Using_All_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Redeem_Two_Coupons_And_Verify_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Usage_More_Than_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	fmt.Println("Metering Date", previousDate)
	create_payload := financials_utils.EnrichMeteringCreatePayload(compute_utils.GetMeteringCreatePayload(),
		uuid.NewString(), uuid.NewString(), cloudAccId, previousDate, "bm-icp-gaudi2", "gaudi2vm", "46441")
	fmt.Println("create_payload", create_payload)
	metering_api_base_url := base_url + "/v1/meteringrecords"
	response_status, _ := financials.CreateMeteringRecords(metering_api_base_url, authToken, create_payload)
	assert.Equal(suite.T(), response_status, 200, "Failed: Failed to create metering data")
	...
	usage_err := billing.ValidateUsageinRange(cloudAccId, financials_utils.GetIntelGaudi2Rate(), "bm-icp-gaudi2", authToken, float64(86), float64(88))
	assert.Equal(suite.T(), usage_err, nil, "Failed to validate usage, validation failed with error : ", usage_err)
...
func (suite *BillingAPITestSuite) Test_Intel_Usage_More_Than_Credits_Redeem_Lesser_Value_Coupon() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Usage_More_Than_Credits_Redeem_Lesser_Value_Coupon_After_Scheduler_Run() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Expire_Coupon_Launch_Paid_Instance() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Intel_Expire_Coupon_Validate_Credits() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	coupon_err := billing.Create_Redeem_Coupon_With_Shrt_Expiry("Intel", int64(15), int64(2), cloudAccId, time.Duration(10))
	assert.Equal(suite.T(), coupon_err, nil, "Failed to create coupon, failed with error : ", coupon_err)
...
func (suite *BillingAPITestSuite) Test_Intel_Expire_Coupon_Validate_Credits1() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	coupon_err = billing.Create_Redeem_Coupon_With_Shrt_Expiry("Intel", int64(40), int64(2), cloudAccId, time.Duration(4))
	assert.Equal(suite.T(), coupon_err, nil, "Failed to create coupon, failed with error : ", coupon_err)
...
func (suite *BillingAPITestSuite) Test_Intel_ExpireCoupon_Validate_Instance_Runs_When_Credits_Available() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	coupon_err1 := billing.Create_Redeem_Coupon_With_Shrt_Expiry("Intel", int64(25), int64(2), cloudAccId, time.Duration(1))
...
func (suite *BillingAPITestSuite) Test_Intel_Redeem_ExpireCoupon_First_Validate_Instance_Runs_When_Credits_Available() {
	userName := utils.Get_UserName("Intel")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	coupon_err := billing.Create_Redeem_Coupon_With_Shrt_Expiry("Intel", int64(20), int64(2), cloudAccId, time.Duration(20))
	assert.Equal(suite.T(), coupon_err, nil, "Failed to create coupon, failed with error : ", coupon_err)

	coupon_err1 := billing.Create_Redeem_Coupon("Intel", int64(15), int64(2), cloudAccId)
	assert.Equal(suite.T(), coupon_err1, nil, "Failed to create coupon, failed with error : ", coupon_err1)
	...
	credits_err := billing.ValidateCredits(cloudAccId, float64(30), authToken, float64(5), float64(5), float64(0))
	assert.Equal(suite.T(), credits_err, nil, "Failed to validate credits, validation failed with error : ", credits_err)

//go:build Functional || Billing || Premium || PremiumIntegration || MultiUser
// +build Functional Billing Premium PremiumIntegration MultiUser
...
func (suite *BillingAPITestSuite) Test_Premium_Send_Invite_Intel_Member() {
...
func (suite *BillingAPITestSuite) Test_Premium_Send_Invite_Standard_Member() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Send_Invite_Premium_Member() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Send_Invite_Member_With_No_CloudAccount() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Is_Able_To_Launch_Instance_when_Admin_has_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Is_Not_Able_To_Launch_Instance_when_Admin_has_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Is_Able_To_Launch_Instance_when_Admin_has_credits_Validate_Usages() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	coupon_err := billing.Create_Redeem_Coupon("Intel", int64(19), int64(2), cloudAccId)
	assert.Equal(suite.T(), coupon_err, nil, "Failed to create coupon, failed with error : ", coupon_err)
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Is_Not_Able_To_Launch_Instance_when_Admin_Uses_All_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	coupon_err := billing.Create_Redeem_Coupon("Intel", int64(14), int64(2), cloudAccId)
	assert.Equal(suite.T(), coupon_err, nil, "Failed to create coupon, failed with error : ", coupon_err)
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Is_Not_Able_To_Launch_Instance_when_Admin_Uses_Less_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
	...
	// Upgrade standard account using coupon
	upgrade_err := billing.Upgrade_to_Premium_with_coupon(cloudAccId, authToken, userToken, int64(20))
	assert.Equal(suite.T(), upgrade_err, nil, "upgrade from standard to premium with coupon failed, with error : ", upgrade_err)
	// Verify Send Invite flow
	memberEmail, memcloudAccId, errEnroll := EnrollMember("IntelMember", "ACCOUNT_TYPE_INTEL", "")
	assert.Equal(suite.T(), errEnroll, nil, "Test Failed in Enrolling Member")
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Removed_Member_Is_Not_Able_To_Launch_Instance_in_Admin() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Removed_Add_Member_Is_Able_To_Launch_Instance_in_Admin() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Usage_and_Credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Is_Able_To_Launch_Instance_In_Members_Account_when_Admin_Uses_All_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Without_Account_Is_Able_To_Launch_Instance_when_Admin_has_no_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_With_No_Cloud_Acc_Is_Able_To_Launch_Instance_when_Admin_has_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Without_CloudAcc_Id_Is_Able_To_Launch_Instance_when_Admin_has_credits_Validate_Usages() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()
...
func (suite *BillingAPITestSuite) Test_Premium_Check_Member_Without_Cloud_Acc_Is_Not_Able_To_Launch_Instance_when_Admin_Uses_All_credits() {
	userName := utils.Get_UserName("Premium")
	userToken, _ := auth.Get_Azure_Bearer_Token(userName)
	userToken = "Bearer " + userToken
	authToken := "Bearer " + auth.Get_Azure_Admin_Bearer_Token()

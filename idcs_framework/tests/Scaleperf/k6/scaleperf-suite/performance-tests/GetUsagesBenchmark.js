...
import { getAzureToken, getAdminToken, getUsages } from "../../utils/HttpClientJF.js";
...
export default function (custom_payload) {
  getUsages(custom_payload.token, custom_payload.payload.cloudaccountId);
}
...
export function handleSummary(data) {
  return {
    ...
    "summaryUsagesPerformance.json": JSON.stringify(data),
    "summaryUsagesPerformance.html": htmlReport(data),
  };
}

...
import { getAzureToken, getAdminToken, getCredits } from "../../utils/HttpClientJF.js";
...
export default function (custom_payload) {
  getCredits(custom_payload.token, custom_payload.payload.cloudaccountId);
}
...
export function handleSummary(data) {
  return {
    ...
    "summaryCreditsPerformance.json": JSON.stringify(data),
    "summaryCreditsPerformance.html": htmlReport(data),
  };
}

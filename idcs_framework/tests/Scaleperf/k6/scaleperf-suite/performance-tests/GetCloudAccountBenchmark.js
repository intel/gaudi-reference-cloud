...
import { getAzureToken, getAdminToken, getCloudaccountMetadata } from "../../utils/HttpClientJF.js";
...
export default function (custom_payload) {
  getCloudaccountMetadata(custom_payload.token, custom_payload.payload.cloudaccountId);
}
...
export function handleSummary(data) {
  return {
    ...
    "summaryCloudAccountPerformance.json": JSON.stringify(data),
    "summaryCloudAccountPerformance.html": htmlReport(data),
  };
}

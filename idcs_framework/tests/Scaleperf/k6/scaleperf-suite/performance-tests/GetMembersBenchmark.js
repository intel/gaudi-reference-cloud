...
import { getAzureToken, getAdminToken, getMembers } from "../../utils/HttpClientJF.js";
...
export default function (custom_payload) {
  getMembers(custom_payload.token, payload.email);
}
...
export function handleSummary(data) {
  return {
    ...
    "summaryMembersPerformance.json": JSON.stringify(data),
    "summaryMembersPerformance.html": htmlReport(data),
  };
}

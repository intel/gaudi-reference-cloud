...
wget https://github.com/IntelAI/models/raw/v3.0.0/models/image_recognition/pytorch/resnet50v1_5/inference/gpu/main.py -O main.py
patch -p1 < resnet50_infer.patch
if [ $? -eq 0 ]; then
    echo "Successfully prepare code"
else

...
echo "Starting bm-spr-gaudi3-dell validation"
...
qual_options=(
    ...
    # ################################## Below tests are failing for bm-spr-gaudi3-dell ########################################################
...
echo "bm-spr-gaudi3-dell validation completed"

...
helm.sh/chart: {{ include "safeguard.chart" . }}
...
*/}}
{{- define "safeguard.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "safeguard.fullname" .) .Values.serviceAccount.name }}
{{- else }}

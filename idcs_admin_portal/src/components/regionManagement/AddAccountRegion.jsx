...
const AddAccountRegion = (props) => {
  ...
  for (const key in form) {
    ...
    if (formItem.sectionGroup === 'region') {
      formElementsRegion.push({
        id: key,
      ...
      <div className="section">
        <div className="row">
          <div className="col-md-6 d-flex flex-column gap-s6">
            {formElementsRegion.map((element, index) => (
            ...
            <ButtonGroup>
              <Button intc-id="navigationBottom-whitelistAccount" disabled={!isValidForm} variant="primary" onClick={onSubmit}>
                Whitelist
              </Button>
...
export default AddAccountRegion
